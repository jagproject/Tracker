      ...
      <div className="space-y-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
            ...
            <button 
                ...
                className="w-full bg-de-black text-white text-sm font-bold py-2 px-4 rounded hover:bg-gray-800 transition-colors mb-4 flex items-center justify-center gap-2"
            >
                {t.generateEmail}
            </button>
